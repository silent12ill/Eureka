...
const VideoInfo = function(props) {
  return (
    <div className='videoInfoContainer'>
      {props.onMindfeed === true ? (<Tag color="#ffd219">My Mindfeed</Tag>) : ''}<Tag color="blue">{ props.currentVideo.category || props.category || props.tempCategory } </Tag> <Tag>{ props.currentVideo.subcategory || props.subcategory || props.tempSubcategory }</Tag> <br />
